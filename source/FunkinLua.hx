...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('fuckedMode', ClientPrefs.fuckedMode);
		set('strumGlow', ClientPrefs.strumGlow);
		...
		Lua_helper.add_callback(lua, "openLink", function(link:String) {
		...
		Lua_helper.add_callback(lua, "addVCREffect", function(camera:String,glitchFactor:Float = 0.0,distortion:Bool=true,perspectiveOn:Bool=false,vignetteMoving:Bool=true) {
		...
		Lua_helper.add_callback(lua, "addBloomEffect", function(camera:String,intensity:Float = 0.35,blurSize:Float=0.5) {
