...
class DialogueEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		var addLineText:FlxText = new FlxText(10, 10, FlxG.width - 20, 'Press 0 to remove the current dialogue line, Press / to add another line after the current one.', 8);
	...
	private static var DEFAULT_TEXT:String = "";
	...
	function onSaveError(_):Void
	{
		...
		_file.removeEventListener(IOErrorEvent.IO_ERROR, onSaveError);
		_file = null;
		FlxG.log.error("Error - We Have been doomed while saving following dialog: ");
	}
}