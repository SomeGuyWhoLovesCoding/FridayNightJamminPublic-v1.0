...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var goption:GameplayOption = new GameplayOption('Botplay Type', 'botType', 'string', 'Default', ["Default", "Osu!"]);
		optionsArray.push(goption);

		var goption:GameplayOption = new GameplayOption('Chart Type', 'SongType', 'string', 'Default', ["Default", "Random", "Faster"]);
		optionsArray.push(goption);
