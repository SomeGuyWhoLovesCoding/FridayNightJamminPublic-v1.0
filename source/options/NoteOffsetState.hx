...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		else if(FlxG.keys.pressed.I) addNum = 50000;
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			var text:FlxText = new FlxText(10, 48 + (i * 30), 0, '', 15);
			text.setFormat(Paths.font("vcr.ttf"), 15, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
